  ...
  return (
    <div className="bg-black text-white text-center">
      <div className="container mx-auto px-4 md:px-20 py-20">
        ...
        <div className={isRTL ? 'text-left' : 'text-right'}><Link href="/work" className="text-gray-300 hover:underline hover:text-white">All Work </Link><i className="fa-solid fa-arrow-up-right-from-square"></i></div>
